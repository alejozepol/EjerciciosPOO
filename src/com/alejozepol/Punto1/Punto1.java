...
public class Punto1 {
    ...
    public static void punto1() {
        ...
        h1.addProducto(1, "Desayuno 2 (Caldo,Huevos fritos, Chocolate y pan)", 5800);
        h1.addProducto(1, "Desayuno 3 (Caldo,Huevos, té y pan)", 5800);
        h1.addProducto(1, "Desayuno 4 (Caldo,Huevos pericos, té y pan)", 5800);
        h1.addProducto(1, "agua con gas", 1500);
        h1.addProducto(1, "agua sin gas", 1500);
        h1.addProducto(1, "gaseosa", 1800);
        h1.addProducto(1, "papas paquetes", 1100);
...
//        JOptionPane.showInputDialog(null, "Seleccione la acción que quieres realizar:",
//                h1.getProducto().toString(), JOptionPane.QUESTION_MESSAGE, null)
        }
